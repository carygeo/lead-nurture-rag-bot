...
- Repo provider-event normalizer — https://github.com/carygeo/lead-nurture-rag-bot/blob/main/src/lead_nurture_rag/provider_events.py — primary repo source for synthetic SendGrid/Postmark/Amazon SES/Mailgun event normalization into `ComplianceGate` inputs.
...
- Provider-event normalizer fixture slice — https://www.twilio.com/docs/sendgrid/for-developers/tracking-events/event ; https://postmarkapp.com/developer/webhooks/webhooks-overview ; https://docs.aws.amazon.com/ses/latest/dg/monitor-sending-activity-using-notifications.html ; https://documentation.mailgun.com/docs/mailgun/user-manual/tracking-messages/ — all returned HTTP 200 on 2026-06-25 03:32 EDT. Used as source basis for synthetic raw provider-event fixtures and local normalization into `ComplianceGate` inputs. Fixture payloads are provider-inspired examples, not complete official contract tests.
